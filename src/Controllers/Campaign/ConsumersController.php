...
class ConsumersController
{
    public function __construct($container){
        ...
        $this->_titulo      = 'Campanhas :: Consumers';
        $this->_subtitulo   = 'Consumers';
        $this->_pagina      = 'consumers';
        $this->_template    = '/interface/campanhas/consumers';
        ...
        # Permissões 
        $this->_permissoes = [
            'listar'    => 'listar-consumer',
            'inserir'   => 'inserir-consumer',
            'editar'    => 'editar-consumer',
            'remover'   => 'remover-consumer'
        ];
    }    
